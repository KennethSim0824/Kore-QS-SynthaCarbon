...
// --- 2. INITIALIZE CLIENT (Outside the route for performance) ---
const client = new SessionsClient({
  keyFilename: "./service-account-key.json",
  projectId: projectId.trim() // Force the correct project ID
});
...
app.post("/api/dispatch", async (req, res) => {
  ...
  try {
    // We use 'client' here to match the initialization above
